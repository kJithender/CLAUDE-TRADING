...
| NVDA   | Tech / AI semi | 2026-05-22 | AI accelerator monopoly thesis intact; forward P/E ~20-22x. Re-verified 2026-07-28 (fresh Alpaca bars through 07-27 close): $196.56, **-5.51% vs 50-day — technical gate FAILS**, materially worse than Monday's -1.00% — the closest-to-a-pass streak broke on today's Asian chip-sector selloff (Kospi -10%, Samsung/SK Hynix -13/-14% on AI-circular-financing and China-competition fears). ATR 3.46%. Earnings confirmed 2026-08-26. | Re-verify at next pre-market; watch for a confirmed cross |
| PWR    | Industrials | 2026-06-12 | Grid/data-center infrastructure buildout; record backlog (USD 48.5B). Re-verified 2026-07-28 (fresh Alpaca bars through 07-27 close): $620.08, **-10.08% below 50d SMA** — technical signal FAILS, essentially unchanged. ATR 3.23%. Q2 earnings 2026-07-30 (2 trading days out, now inside the blackout) plus transformer-capacity-expansion catalyst keep this off the stale-decoration purge list. | Keep — re-verify technical gate at next pre-market; earnings 2026-07-30 |
| MSFT   | Tech / Enterprise AI | 2026-05-22 | Azure AI platform compounding. Re-verified 2026-07-28 (fresh Alpaca bars through 07-27 close): $389.15, **-2.36% vs 50d SMA — technical gate FAILS**. ATR 2.70%. FY26 Q4 earnings confirmed 2026-07-29 (1 trading day out — inside the blackout regardless of the technical gate). | Re-verify at next pre-market; earnings 2026-07-29 |
| COST   | Consumer Defensive | 2026-05-29 | Membership model loyalty. Re-verified 2026-07-28 (fresh Alpaca bars through 07-27 close): $951.56, **-1.55% below 50d SMA** — technical signal FAILS, narrowing from -3.54% Monday. ATR 1.79% (low). Fiscal Q4 2026 earnings confirmed for 2026-09-24. | review_by 2026-09-24 |
| LRCX   | Semi Equipment | 2026-06-08 | Re-verified 2026-07-28 (fresh Alpaca bars through 07-27 close): $291.41, **-14.07% vs 50-day — technical gate FAILS**, worse than Monday's -9.75% on today's chip-sector selloff, ATR 6.17% (very high). Valuation remains decisively disqualifying regardless (GF Value ~USD 132 vs price >USD 290, P/E >60x). Earnings confirmed 2026-07-29 (1 trading day out — inside the blackout regardless). | Re-verify at next pre-market; watch for a genuine valuation reset |
