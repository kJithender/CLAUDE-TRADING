...
| V      | Financials | 2026-06-10 | **HELD (22sh, avg $355.058182).** Conviction **A** (upgraded from B, Monday review 07-20). Q3 FY26 beat-and-moderate print (07-28) HOLD decision stands. **2026-08-04: announced USD 2.4B acquisition of BioCatch** (fraud-detection/behavioral-biometrics), extending the existing fraud-detection/agentic-commerce catalyst; Cantor Fitzgerald raised PT to USD 445 (from USD 410); USD 0.67/share dividend declared, ex-date 08-11. | review_by 2026-09-15 (renewed 2026-08-17 pre-market; interim re-check on cost-cutting execution/margin trend; next earnings not yet announced, estimated late October) |
| UNH    | Healthcare / Managed Care | 2026-07-17 | **STOPPED OUT 2026-08-17**, −6.948%, 25sh entry $422.28 → exit $392.94, held 28 days. The 10% trailing stop fired hours before UNH's own 2026-08-17 `review_by` deadline — the position had been downgraded to Conviction B (08-10) then effectively C (08-17 pre-market) on a slow, catalyst-less drift with the 07-16 beat-and-raise fully priced in; no fresh company-specific negative catalyst found at the time of the stop (only the already-known 08-13 shareholder lawsuit re-litigating the 2024 Change Healthcare breach). Not a thesis break — full post-mortem in `closed-trades.md`. | Re-verify SMA/ATR/valuation at next pre-market before any re-entry consideration; next earnings not until 2026-10-27 |
...
| SHOP   | Consumer Discretionary / E-commerce Infrastructure | 2026-08-07 | **VETTED 2026-08-10 — FAILS.** First full gate check: +27.128% vs 50-day SMA (nearly 3x the 10% chase cap), ATR 4.56%; WebSearch-sourced fair-value estimates (~USD 116) sit well below the current USD 151.58 print (~30% premium). The "monster" Q2 beat (revenue +34% YoY) is real but already fully priced in and then some. Not a candidate; would need a substantial pullback toward fair value plus a non-extended technical setup. | Re-verify if a material pullback occurs; not currently a candidate on either technical or valuation grounds |
...
| PWR    | Industrials | 2026-06-12 | Grid/data-center infrastructure buildout; record backlog now USD 53.4B. Q2 2026 earnings (reported 2026-07-30 before open) beat decisively (EPS USD 4.24 vs USD 3.31 est., revenue USD 9.56B vs USD 8.61B est., FY26 guidance raised to USD 16.45-16.95 EPS). **2026-08-13: posts a fresh, unconfirmed positive SMA cross (+0.586%, was −0.595% 08-11)** after whipsawing around the SMA since 08-04 — moot regardless since **disqualified by the GuruFocus valuation veto**, freshly re-verified 08-08 — GF Value USD 465.85 vs price ~USD 678-680, ~44% overvalued ("Significantly Overvalued," GF Score 89-90/100), trailing P/E ~77x. Same valuation-veto discipline that purged AAPL and repeatedly blocked LRCX. | Re-verify valuation gap at future pre-markets; not a candidate unless price resets materially toward GF Value or the overvaluation flag clears |
...
| COST   | Consumer Defensive | 2026-05-29 | **HELD (7sh, avg ~USD 960.84, bought 2026-08-17 planned/pending market-open).** Full 5-signal check run 2026-08-17 pre-market: 4-of-5 clear (earnings momentum: Q3 FY26 beat EPS USD 4.93 vs ~USD 4.79 est; catalyst: Q4 earnings 09-24 + ongoing membership-fee/e-commerce growth; technical: +1.087% vs 50-day, 3rd confirming session, ATR 1.46%; macro: staples rotation intact). **Valuation signal FAILS** — PEG 3.88 (>2.5 threshold), forward P/E ~42-44x vs sector ~26x average (a premium, not a discount). **Correction to 2026-08-14's review:** GuruFocus's "Fairly Valued"/~8%-below-GF-Value reading is an intrinsic-DCF estimate, not the PEG/peer-multiple test this strategy's entry-signal #3 actually applies (the same test that cleared UNH at PEG 1.73-2.07 and NVDA at 0.27-0.47) — it should not have been read as reversing the valuation flag. Sized as a reduced starter (~6.8% of equity, below the normal 7-9% range) specifically to reflect the one failed signal. | review_by 2026-09-22 (2 trading days pre-earnings, forces the earnings-window hold/trim/exit call) |
| LRCX   | Semi Equipment | 2026-06-08 | **2026-08-14 weekly review:** technical gap narrowed sharply on this week's semiconductor-sector rebound — fresh Alpaca bars through 08-14 close show $332.44, **-1.614% vs 50-day** (was -3.399% 08-13, -12.803% 08-04) — still technically FAILS but much closer than at any point since tracking began. **Valuation veto reconfirmed, not weakened:** fresh GuruFocus pull (08-14) shows LRCX **131.6% overvalued** (GF Value USD 134.71 vs price ~USD 311-312, P/E 58.87x vs its own 5-year median 23.27x) — decisively disqualifying regardless of the narrowing chart. Not a candidate. | Re-verify at next pre-market; valuation still disqualifying regardless of technicals |
...
- **2026-08-14 precedent:** this trigger fired for the first time (rolling
  4-week window 2026-07-17 → 2026-08-14: Bull -0.8270% vs SPY +4.3180% =
  -5.1450pp). The mandated review found no sector-weight or thesis problem
  (no sector near its cap, all 4 held theses intact) — the gap is entirely
  cash-under-deployment during a sustained rate-cut-driven rally, not a
  process or guardrail defect. Resolution: no guardrail change; the
  concrete adjustment was to treat COST's newly-cleared technical +
  valuation gates as a priority full vetting rather than a routine
  watchlist note (see `weekly-review.md` week-ending-2026-08-14 entry for
  full reasoning). Future reviews: if this trigger fires again, check
  whether a cleared-gate candidate is being acted on promptly before
  concluding a guardrail needs to change.
- **2026-08-21 resolution:** the trigger did not re-fire. The following
  week's rolling window (2026-07-24 → 2026-08-21: Bull -0.28184% vs SPY
  +3.84324% = -4.12508pp) fell back under the 5% threshold on its own,
  with no guardrail or entry-signal change made in between — SPY had a
  rough week (Treasury/geopolitical-driven selloff) that Bull's book
  mostly avoided, the same mirror-image mechanism reversing direction.
  This is dated evidence supporting the 08-14 conclusion: the gap is a
  factor-exposure cost of the sector mix and cash posture, not a process
  defect, and it can close on its own when market conditions rotate.

## Active Macro Watches (rebuilt 2026-07-01, post-reset; updated 2026-08-13)

- **2026-08-13 update — PWR posts a fresh, unconfirmed positive SMA cross but stays valuation-vetoed; July PPI due 8:30 AM ET, on the heels of yesterday's cooler CPI:** S&P 500 futures edging higher (~+0.08-0.2%) as traders digest yesterday's cooler-than-feared July CPI (+0.1% MoM) and await today's July PPI print (8:30 AM ET, consensus +0.2% MoM headline/+0.3% core). **10yr Treasury 4.69%** (08-12 close) — comfortably below the 4.75% new-buy gate. **Watchlist re-verification (fresh Alpaca bars through 08-12 close):** PWR posted its first positive SMA cross in a week (+0.586%, was −0.595% 08-11) — a single unconfirmed session, and moot regardless since a fresh GuruFocus pull (08-08) still shows ~44% overvaluation ("Significantly Overvalued"). MSFT (+20.030%) and SHOP (+24.080%) both remain deeply extended, COST fails (−0.090%), LRCX fails technically (−3.399%, gap narrowed materially from −7.733%) and on valuation (P/E >60x). No qualifying entry. All 4 held positions (LLY, UNH, V, NVDA) HOLD, no thesis-breaking news, no thesis contracts due. **Open positions:** LLY (since 2026-07-13, conviction A), UNH (since 2026-07-20, conviction B), V (since 2026-07-07, conviction A), NVDA (since 2026-08-05, conviction A). No trades planned 2026-08-13.
- **2026-08-11 update — COST posts a first, unconfirmed positive SMA cross; 10yr Treasury eases slightly, still comfortably below the new-buy gate:** S&P 500 futures edging higher (~+0.1%) pre-market, continuing to digest Friday's weak July jobs report; oil elevated on renewed U.S.-Iran/Strait-of-Hormuz tension (a headwind to watch, not yet risk-off for equities). **10yr Treasury eased to 4.70%** (tradingeconomics.com, explicitly dated 08-11) — below the 4.75% new-buy gate. **July CPI releases tomorrow (08-12, 8:30 AM ET)** — real volatility catalyst, PPI follows Wednesday 08-13. **Watchlist re-verification (fresh Alpaca bars through 08-10 close):** PWR fell back below its 50-day again (−2.105%), MSFT further extended (+23.890%), LRCX still fails technically and on valuation (−9.284%). **COST posted its first positive SMA cross in weeks (+0.233%, was −0.386% 08-10)** — a single unconfirmed session, not yet an entry signal; watch for a second confirming session tomorrow. SHOP not re-pulled today (unchanged expectation — extended/overvalued). No qualifying entry. NVDA (held) benefited from a positive, non-thesis-changing catalyst — a 500B+ USD AI-infrastructure financing consortium with 7 Wall Street banks plus a new SK Group 2GW deal. **Open positions:** LLY (since 2026-07-13, conviction A), UNH (since 2026-07-20, conviction B), V (since 2026-07-07, conviction A), NVDA (since 2026-08-05, conviction A). No trades planned 2026-08-11.
- **2026-08-10 update — new week opens on a constructive tape; SHOP's first full vetting pass fails, UNH conviction downgraded to B:** S&P futures +0.13-0.6% pre-market (reports vary), Nasdaq futures also higher, continuing Friday's weak-jobs-report rate-cut-odds rally (S&P/Dow/Nasdaq all closed at records Friday). **10yr Treasury holding at 4.65%**, flat over the past month, comfortably below the 4.75% new-buy gate. **This week's key catalysts: CPI Tuesday 08-12, PPI Wednesday 08-13** — real volatility risk, flagged for the week's pre-market re-checks. **Watchlist re-verification:** PWR reversed back below its 50-day again (−0.704%, a repeated whipsaw around the SMA since 08-04), MSFT still extended (+22.831%), COST (−0.386%) and LRCX (−7.844%, valuation-disqualified) both still fail. **SHOP's first full gate check (added 08-07 unvetted) fails decisively** — +27.128% vs 50-day (nearly 3x the chase cap), priced (USD 151.58) well above WebSearch-sourced fair-value estimates (~USD 116). No qualifying entry. **Monday conviction review: LLY A, V A, NVDA A (first review), UNH downgraded to B** — thesis intact, no company-specific break, but the 07-16 catalyst is priced in and the position has been flat-to-negative for 3 straight weeks with no fresh trigger before its 08-17 review_by; no name at 3 consecutive C's, no forced trim. **Open positions:** LLY (since 2026-07-13, conviction A), UNH (since 2026-07-20, conviction B), V (since 2026-07-07, conviction A), NVDA (since 2026-08-05, conviction A). No trades planned 2026-08-10.
