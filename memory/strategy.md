...
|--------|--------|------------|-----------------|-----------------|
| LLY    | Healthcare | 2026-05-22 | **HELD (8sh, avg $1,174.35625).** Conviction **A** (Monday review 07-20). GLP-1 dominance; Medicare Bridge live since 2026-07-01. AtaiBeckley acquisition definitive agreement (up to $3.8B). Retevmo full FDA approval. **2026-08-04 pre-market: forced earnings-window decision resolved** — earnings before market open tomorrow (2026-08-05, 1 trading day out). Stock down further (-4.476% from entry) on broad "priced for perfection" valuation profit-taking (~40x P/E) plus a modest Erste Group EPS-estimate trim; no company-specific negative catalyst found. HOLD full position, no trim. | review_by 2026-08-06 (forces post-earnings read the day after the print) |
...
| NVDA   | Tech / AI semi | 2026-05-22 | AI accelerator monopoly thesis intact; forward P/E ~20-22x. Re-verified 2026-08-04 (fresh Alpaca bars through 08-03 close): $206.72, **+0.436% vs 50-day — first positive cross since tracking began**, up from -2.628% (07-31) and -5.575% (07-30). ATR 3.71%. Single session, UNCONFIRMED per the standing multi-session-confirmation lesson (6+ prior failed crosses). Earnings confirmed 2026-08-26. | Watch for a 2nd consecutive confirming session at next pre-market |
| PWR    | Industrials | 2026-06-12 | Grid/data-center infrastructure buildout; record backlog now USD 53.4B. Q2 2026 earnings (reported 2026-07-30 before open) beat decisively (EPS USD 4.24 vs USD 3.31 est., revenue USD 9.56B vs USD 8.61B est., FY26 guidance raised to USD 16.45-16.95 EPS). Re-verified 2026-08-04 (fresh Alpaca bars through 08-03 close): $680.08, **-0.066% vs 50-day — essentially flat, still technically FAILS** (hasn't crossed yet), narrowed from -3.542% (07-30). ATR 3.54%. | Watch for the actual cross at next pre-market |
...
## Active Macro Watches (rebuilt 2026-07-01, post-reset; updated 2026-08-04)
