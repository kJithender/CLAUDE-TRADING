...
## Active Macro Watches (rebuilt 2026-07-01, post-reset; updated 2026-07-21)

- **Iran war re-escalation (STILL ACTIVE, mediators now proposing a fresh 10-day ceasefire):** as of 2026-07-21, oil eased ~1-1.4% (Brent ~$88.01, WTI ~$82.29) on reports mediators proposed a 10-day ceasefire to revive the June 17 MOU, though fresh strikes and a Houthi "maritime embargo" threat against Saudi Arabia continue alongside the talks. Treat as an active, unresolved risk-off catalyst until a deal is actually signed — de-escalation headlines have reversed before.
