...
|--------|--------|------------|-----------------|-----------------|
| LLY    | Healthcare | 2026-05-22 | **HELD (8sh, avg $1,174.35625).** Conviction **A** (Monday review 07-20). GLP-1 dominance; Medicare Bridge live since 2026-07-01. AtaiBeckley acquisition definitive agreement (up to $3.8B). Retevmo full FDA approval. **2026-08-05 pre-market: earnings-window decision resolved — clean beat-and-raise.** Q2 2026 EPS USD 8.38 vs USD 6.07 est. (~38% beat), revenue USD 23.0B (+48% YoY, Mounjaro +91%/Zepbound +44%), FY revenue guidance raised to USD 85-87B (from USD 82-85B). Stock +5.578% today, flipped from -5.278% to +0.303% from entry. HOLD full position, no trim, no scale-up pending tomorrow's formal post-full-session review. | review_by 2026-08-06 (forces the post-full-session read) |
...
| NVDA   | Tech / AI semi | 2026-05-22 | **PLANNED BUY 2026-08-05** (18sh, ~3.89% of equity, halved for ATR 3.63%). AI accelerator monopoly thesis intact; forward P/E ~20-24x, PEG ~0.27-0.47. Re-verified 2026-08-05 (fresh Alpaca bars through 08-04 close): $211.96, **+3.057% vs 50-day — SECOND consecutive confirmed session**, clearing the multi-session-confirmation bar after 6+ prior failed single-session crosses (was +0.436% 08-03). Pre-market 08-05 extends to ~$215.03 (~+4.55% vs 50-day), not extended past the 10% chase cap. ATR 3.63% (>3%, size halved). 4-5 of 5 entry signals pass (sector cloud beats from MSFT/AMZN, Strong Buy consensus 85%, avg PT USD 302.83, BofA reiterated Buy 08-04 PT USD 220). Earnings confirmed 2026-08-26 (no blackout). | review_by 2026-08-24 (2 trading days pre-earnings, forces the earnings-window hold/trim/exit call) |
| PWR    | Industrials | 2026-06-12 | Grid/data-center infrastructure buildout; record backlog now USD 53.4B. Q2 2026 earnings (reported 2026-07-30 before open) beat decisively (EPS USD 4.24 vs USD 3.31 est., revenue USD 9.56B vs USD 8.61B est., FY26 guidance raised to USD 16.45-16.95 EPS). Re-verified 2026-08-05 (fresh Alpaca bars through 08-04 close): $692.90, **+1.890% vs 50-day — first actual cross**, narrowed/crossed from -0.066% (08-04). ATR 3.62%. Single session, UNCONFIRMED per the standing multi-session-confirmation lesson (the same bar NVDA just cleared). | Watch for a 2nd consecutive confirming session at next pre-market |
